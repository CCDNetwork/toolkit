...
<table>
  ...
  <tr>
    <td>One</td>
    <td>Preliminary</td>
    <td>Explanations of Guiding Principles, Applicable Law, Definitions of Terms, Data Use, etc</td>
  </tr>
  <tr>
    <td>Two</td>
    <td>Data Stewardship</td>
    <td>Definitions of various governance bodies: the Data Steward, Data Host, and Oversight Committee</td>
  </tr>
  <tr>
    <td>Three</td>
    <td>Data Subjects</td>
    <td>Descriptions of Data Subject Rights and Complaints Mechanism</td>
  </tr>
  <tr>
    <td>Four</td>
    <td>Technical Measures</td>
    <td>Guidance for Data Security, Data Subject Accounts, Data Sharing, Retention Periods, Third Party Access</td>
  </tr>
  <tr>
    <td>Five</td>
    <td>Signatures</td>
  ...
  <tr>
    ...
    <td>Material required for implementation</td>
    <td>e.g. draft Implementation Timeline, Focal Point directory, and Purpose definitions</td>
  </tr>
</table>
