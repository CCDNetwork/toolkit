...
In 2022 our research identified two key requirements for data portability in the humanitarian sector: creating interoperability between systems, and ensuring data rights for aid recipients. CCD members identified four use cases in which interoperability was critical:
...
Despite their importance, we found almost no tools to help our organisations address these challenges. So in 2023-24 we set up two pilot projects - one in South Sudan and one in Ukraine - and developed a new model of data governance, supported by a set of open source tools.
